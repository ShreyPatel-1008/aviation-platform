...
export default function TradesPage() {
    ...
    const fetchArticles = useCallback(async () => {
        ...
        try {
            ...
            const res = await fetch(`/api/articles/trades?${params}`);
    ...
    return (
        <div>
            <div className="page-header">
                <h1>💼 Aviation Trades</h1>
                <p>Aircraft orders, deliveries, leases, fleet expansions, MRO contracts, and business deals</p>
            </div>
                            ...
                            >
                                ...
                                <div className="article-body">
                                    <div className="article-header">
                                        ...
                                        <span className="category-badge trade">💼 Trade</span>
                                    </div>
